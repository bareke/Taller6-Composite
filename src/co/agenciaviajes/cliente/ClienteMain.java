...
public class ClienteMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Ejemplo de un paquete a Tierra Santa, que visitará tres paises: Italia, España y Francia
        PaqueteComponent principal2 = new RegionComponent("Tierra Santa");
        PaqueteComponent pais4 = new RegionComponent("Israel");
        PaqueteComponent pais5 = new RegionComponent("Egipto");
        PaqueteComponent pais6 = new RegionComponent("Irak");

        PaqueteComponent ciudad5 = new CiudadComponent("Jerusalen", 1000000);
        PaqueteComponent ciudad6 = new CiudadComponent("Acre", 2000000);
        PaqueteComponent ciudad7 = new CiudadComponent("El Cairo", 3000000);
        PaqueteComponent ciudad8 = new CiudadComponent("Alejandría", 2000000);
        PaqueteComponent ciudad9 = new CiudadComponent("Bagdad", 2000000);
        ...
        pais4.addComponent(ciudad6);
        pais5.addComponent(ciudad7);
        pais5.addComponent(ciudad8);
        pais6.addComponent(ciudad9);
        ...
        System.out.println(" Ciudad " + pais4.getComponent(0).getNombre());
        System.out.println(" Ciudad " + pais4.getComponent(1).getNombre());
        
        System.out.println("");
        System.out.println(" Pais 5 = "
                + pais5.getNombre() + " " + pais5.getComponentPrecio() + " Pesos");
        System.out.println(" Ciudad " + pais5.getComponent(0).getNombre());
        System.out.println(" Ciudad " + pais5.getComponent(1).getNombre());
        
        System.out.println("");
        System.out.println(" Pais 6 = "
                + pais6.getNombre() + " " + pais6.getComponentPrecio() + " Pesos");
        System.out.println(" Ciudad " + pais6.getComponent(0).getNombre());
